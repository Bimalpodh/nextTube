...
// Optimized API: Removed contentDetails, reduced results to 20, specified regionCode
export const YOUTUBE_VIDEOES_API =
  "https://youtube.googleapis.com/youtube/v3/videos?" +
  "part=snippet,statistics&chart=mostPopular" +
  "&maxResults=20&regionCode=IN&key=" + GOOGLE_API_KEY;

export const VIDEO_API = `https://www.googleapis.com/youtube/v3/videos?part=snippet,statistics&key=${GOOGLE_API_KEY}&`;

export const COMMENTS_API = `https://www.googleapis.com/youtube/v3/commentThreads?part=snippet&key=${GOOGLE_API_KEY}&maxResults=50&videoId=`;
